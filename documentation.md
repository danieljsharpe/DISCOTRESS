...
---- | ----------- | ----------------
*fpp\_properties.dat* | properties of simulated &#120068; &#8592; &#120069; paths, together yielding numerical estimates of the probability distributions for path properties in the first passage path ensemble | path no. / path length / path time / ln of path probability / path entropy flow
